...
> As análises de robustez metodológica (confound de plataforma, within-platform,
> scan-batch) foram retiradas do código nesta simplificação de escopo — viram
> discussão no texto do TCC. Ficam preservadas na tag `snapshot-2026-06-06-robustez`
> e na cópia de segurança do projeto.
